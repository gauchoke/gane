...
dialogWinPointsCampaings(BuildContext contextContainer, String buttonLeft, Function playvideo, String title, String logo, String image, String points, int format) async {
